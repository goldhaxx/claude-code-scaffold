# Feature: [operations.sh](<http://operations.sh>) exec dispatches http-mechanism commands
...
* **Re-architecting **[**operations.sh**](<http://operations.sh>)** registry.** Out of scope per BTS-211 body.
