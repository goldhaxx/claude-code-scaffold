...
* **Substrate primitive timing.** [docs-check.sh](<http://docs-check.sh>), [operations.sh](<http://operations.sh>), [linear-query.sh](<http://linear-query.sh>) stay un-instrumented in this ship. Separate sweep.
