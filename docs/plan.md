...
- **Implement:** Apply the same `(if $project_id != "" then " --project-id " + ... ...)` pattern to the `jq -n` blocks at operations.sh lines 547, 573, 601, 648, 498 (backlog.list).
...
- [ ] No new shellcheck warnings on operations.sh
