...
| `linear-query.sh list-documents [--project <id>] [--issue <id>] [--initiative <id>] [--limit N]` | BTS-204: list Documents filtered by parent. Returns array of `{id, title, slugId, updatedAt, createdAt}`. |
